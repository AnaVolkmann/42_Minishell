...
/*   Updated: 2025/03/16 21:57:13 by ana-lda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @details Appends the new token to the end of the list if it exists, otherwise sets the new token as the head.
 */
 ...
 * @details Iterates through the token list and frees each token's value and the token itself.
 */
 ...
 * @param in_quote A flag indicating if a quote is currently open (1 if open, 0 if closed).
 * @param quote_char The character used for quoting (either single or double quote).
 * @details If a quote is encountered, it either opens or closes the quote status.
 */
 ...
 * @param tokens A pointer to the head of the token list.
 * @details If a word is detected between `start` and `input`, a new word token is created and added to the list.
 */
