...
/*   Updated: 2025/03/16 21:58:20 by ana-lda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Handles special characters (e.g., redirection, pipe) in the input string and creates corresponding tokens.
 * @param input A pointer to the input string to be processed.
 * @param tokens A pointer to the head of the token list.
 * @details Detects special characters like '>', '<', and '|' and creates corresponding redirection or pipe tokens.
...
/**
 * @brief Processes a word from the input string and adds it as a token to the token list.
 * @param input A pointer to the input string to be processed.
 * @param tokens A pointer to the head of the token list.
 * @details Extracts a word (continuous sequence of non-space, non-special characters) from the input and creates
 *          a T_WORD token. Updates the `input` pointer to skip over the processed word.
 */
...
/**
 * @brief Tokenizes an input string by splitting it into tokens based on spaces, special characters, and quotes.
 * @param input The input string to be tokenized.
 * @return A pointer to the head of the list of tokens.
 * @details Iterates through the input string, handling special characters and words, and creates corresponding tokens
