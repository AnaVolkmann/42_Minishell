...
/**
 * @brief Checks if a string contains any quote characters (single or double quotes).
...
/**
 * @brief Reads lines from the user, expanding variables if necessary, and writes them to a specified output.
 ...
 * @param is_expandable Flag indicating whether variable expansion should occur.
 */
...
/**
 * @brief Handles reading input for a here-document and writes the result to a pipe.
