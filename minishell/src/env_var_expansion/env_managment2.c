...
/*   Updated: 2025/03/21 16:34:04 by alawrence        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/** @brief Replaces or adds an environment variable in 
 * the environment structure. Searches for an existing
 *  environment variable and replaces it with the new value if found. 
 * If the variable does not exist, it adds a new environment variable entry. 
 * The function handles different cases of variable formatting,
 *  such as with or without an equals sign (`=`).
 ...
 * Converts the given status value to a string and updates
 *  an environment variable with a given start string.
 ...
 * This function checks if the given string consists solely of
 *  spaces, tabs, or newlines and returns true
 *  if the string is empty or consists only of whitespace characters.
 * @param line The input string.
 * @return 1 if the line is empty or contains only whitespace
...
/** @brief Checks if the provided line is empty, a newline,
 *  or consists of only whitespace characters.
 * This function checks if the line is either empty, a newline 
 * (`\n`), or just whitespace. 
 * It frees the line if it meets any of these conditions.
 ...
 * This function creates a new string that is a copy of the original
 *  string with all instances of the specified character (`del`) 
 * removed.
 * @param str The input string.
 * @param del The character to remove from the string.
 * @return A new string with the character removed, or NULL if 
