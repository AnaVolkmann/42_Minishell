...
/*   Updated: 2025/03/21 12:00:09 by ana-lda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @details Maps specific error codes (e.g., 2 and 13) to
 *the respective exit statuses (127 and 126). 
 ...
 * @details Continuously divides the number by 10 to count the
 * number of digits. Handles the case where the number is 0 by returning 1. */
 ...
 * @details Iterates through the array of environment variables,
 * freeing each key-value pair and the array itself.*/
 ...
 * @details Frees memory associated with the environment, 
 * then exits the shell with the provided exit status.*/
 ...
 * @details Closes both the file descriptors provided,
 *  used for cleaning up after piping operations */
