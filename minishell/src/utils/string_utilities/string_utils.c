...
/*   Updated: 2025/03/16 21:58:52 by ana-lda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Removes single and double quotes from a string while preserving the content inside.
 ...
 * @details Iterates through the input string and removes quotes (single and double) while respecting the pairing of quotes. 
 ...
 * @return A new dynamically allocated string that is a copy of the source string.
 ...
 * @details Copies a portion of the string `s_2` from the index `st` to `en` (exclusive) into the string `s_1`.
 */
