...
/*   Updated: 2025/03/16 21:59:30 by ana-lda-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @details Iterates through the string and counts the number of characters until the `end` character is encountered.
 */
...
/**
 * @brief Compares two strings for equality, optionally using a third string for comparison.
 * @param s_1 The first string to compare.
 * @param s_2 The second string to compare.
 * @param s_3 The third string to compare if the first two are equal (can be NULL).
 * @return 1 if the strings are equal, 0 otherwise.
 * @details Compares `s_1` and `s_2`. If they are equal, it checks against `s_3` (if provided). 
 ...
 * @details Converts each character in the string to its corresponding integer value and constructs the resulting number.
 ...
 * @details Iterates through the array until a NULL pointer is encountered and counts the number of strings in the array.
 */
 ...
 * @details Iterates through the array, freeing each string, and then frees the array itself.
 */
